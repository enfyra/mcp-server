...
'### Auth and publishedMethods (Enfyra server)',
    ...
    '- For browser SSR apps, REST goes through the app proxy prefix and Socket.IO goes through the app `/ws/<namespace>` bridge. Do not connect app browser code directly to the hidden backend. Do not add custom token cookies when the Enfyra app/proxy already owns cookies.',
