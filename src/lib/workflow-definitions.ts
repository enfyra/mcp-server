...
export const TOOL_WORKFLOWS = [
  ...
  },
  {
    ...
    nextStepTemplate: [
      ...
      'For flows use multiple named steps with one business operation each; for websocket code keep connection lifecycle in the gateway and one event contract per event record; keep OAuth lifecycle and bootstrap sources focused on their own lifecycle contracts.',
