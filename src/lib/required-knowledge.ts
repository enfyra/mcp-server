...
const GLOBAL_RULES_SECTIONS = [
  ...
  },
  {
    ...
    rules: [
      ...
      'The production `/gateway/v1/*` route is explicitly IP-limited in pre_auth: use a route-specific rate_limit_by_ip guard with the gateway methods. Do not use rate_limit_by_user for this gateway; PAT identity is checked inside the hook and upstream request cost is controlled at the transport boundary.',
