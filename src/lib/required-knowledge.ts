...
const EXTENSION_SECTIONS = [
  ...
  },
  {
    ...
    rules: [
      ...
      'For generated high-contract UI in guided mode, call build_extension_ui with the matching kind after reading this acknowledgement; it lazy-dispatches drawer, modal, page shell, permission gate, empty state, resource list, form editor, widget, menu notification, account panel item, tabs, upload modal, or review contracts without loading every builder tool at startup.',
