...
const EXTENSION_SECTIONS = [
  ...
  },
  {
    ...
    rules: [
      ...
      'For generated high-contract UI in guided mode, call build_extension_ui with the matching kind after reading this acknowledgement; it lazy-dispatches drawer, modal, page shell, permission gate, empty state, resource list, form editor, widget, menu notification, account panel item, tabs, upload modal, api usage, notify, runtime review, theme classes, theme review, or full review contracts without loading every builder tool at startup.',
  ...
  },
  {
    ...
    rules: [
      ...
      'Do not write useNotify shapes from memory. Call build_extension_ui kind=notify for known-good notification snippets. Call build_extension_ui kind=api_usage only when a generated fetch/mutation scaffold is useful.',
